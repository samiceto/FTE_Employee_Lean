...
class GmailWatcher(BaseWatcher):
    def __init__(self, vault_path: str):
        ...
        self.needs_action = self.vault_path / 'Need_Action/email_replies'  
...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 2:
        print("Usage: python gmail_watcher.py /path/to/your/vault")
        sys.exit(1)
    
    vault_path = sys.argv[1]
    
    watcher = GmailWatcher(vault_path)
    watcher.run()   # ← This starts the infinite polling loop